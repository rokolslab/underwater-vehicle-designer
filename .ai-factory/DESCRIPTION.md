...
- 3D-корпус как набор sampled `SectionShape` колец на Three.js с режимами `solid`, `x-ray`, регулируемой прозрачностью и независимыми clipping-сечениями; текущий `SectionShape` реализует exact ellipse.
