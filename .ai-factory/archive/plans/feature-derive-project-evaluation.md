...
- [x] **Задача 8: Выполнить docs checkpoint и полный release gate.** Обновлены architecture/calculations/testing/data-export docs, `AGENTS.md`, `.ai-factory/ARCHITECTURE.md` и historical UI refactoring context; release gates выполнены в текущем checkpoint.
